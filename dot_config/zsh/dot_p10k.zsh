# Generated by Powerlevel10k configuration wizard on 2025-02-22 at 16:09 MST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    nordvpn_nm                 # nordvpn connection status, linux only (https://nordvpn.com/)
  ...
  # Attempt to use fractional en/em spaces to fix spacing issue
  #typeset -g POWERLEVEL9K_NORDVPN_VISUAL_IDENTIFIER_EXPANSION='  '
  # Use %G glitch char to fix monospace issues
  typeset -g POWERLEVEL9K_NORDVPN_VISUAL_IDENTIFIER_EXPANSION='%{%G%}'
  ...
  typeset -g POWERLEVEL9K_VPN_IP_BACKGROUND=047
